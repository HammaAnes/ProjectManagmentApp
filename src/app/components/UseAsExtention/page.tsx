    ...
    return (
        ...
        <div className="max-w-[1289px] w-full flex justify-between items-center">
            <div className=" text-white leading-tight flex flex-col justify-between gap-[60px]">
                ...
                <button className="bg-[#4F9CF9] w-[227px] h-[60px] text-[18px] rounded-[8px] text-white font-[inter] font-medium flex justify-center gap-2.5 items-center">Let's Go <img src="right_arrow.svg" alt="right_arrow" /></button>
            </div>
            ...
            <img
                ...
                alt="illustration"
                className="min-w-[820px] min-h-[549px] bg-[#C4DEFD]"
            />
            </div>
        </div>
        </div>
